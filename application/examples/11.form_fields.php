...
<b>Input password:</b>
<br>
<?php input_password(["id" => "data_input_password", 
...
<?php checkbox(["id" => "data_ckbxcolor_$val", 
                  "name" => "data[ckbxcolor][]", 
                  "class" => "my_class",
                  "value" => $val, 
                  //"checked" => true,
...
<?php radiobutton(["id" => "data_radiocolor_$val", 
