...
class MySQL_DBWorker extends DBWorker
{
  ...
  public function field_count()
  {
    ...
    if(!$this->mysqli_result) return false;
  ...
  public function field_info_by_num($num)
  {
    ...
    {
      if(in_array($field_info["type"], [0, 1, 2, 3, 4, 5, 7, 8, 9, 13, 16, 246])) $field_info["numeric"] = 1;
      if(in_array($field_info["type"], [249, 250, 251, 252])) $field_info["binary"] = 1;

      if(isset($mysqli_type[$field_info["type"]])) $field_info["type"] = $mysqli_type[$field_info["type"]];
